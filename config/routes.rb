Rails.application.routes.draw do
  ...
  post   "likes/:impression_id/create" => "likes#create"
  ...
  # updateにはpatdhを用いる（REST APIの標準的なルール）
  patch   "impression/update" => "impressions#update"
  # createにはpostを用いる（REST APIの標準的なルール）
  post   "impression/create" => "impressions#create"
